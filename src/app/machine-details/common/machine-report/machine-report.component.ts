...
export class MachineReportComponent implements OnInit {
  headerWithColumns = [{headers : "start_time",value:"start_time"},{headers : "end_time",value:"end_time"},{headers : "status",value:"status"},{headers : "reason",value:"reason"}]; //{headers : "Position",value:"position"},{headers : "Name",value:"name"},{headers : "Weight",value:"weight"},{headers : "Symbol",value:"symbol"}
